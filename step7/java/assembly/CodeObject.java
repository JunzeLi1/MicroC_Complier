...
public class CodeObject {
	...
	ast.CondNode.OpType optype; // storing the conditional type to help with branch creation.
	String leftTemp; // required for creating branch insts
	String rightTemp; //required for creating branch
	//added for step 3
	public enum OpType {
		EQ,
		NE,
